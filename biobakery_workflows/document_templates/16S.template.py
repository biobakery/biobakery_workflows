...
filtered_data_pcoa=numpy.array(filtered_data)/100.0
document.show_pcoa(samples, filtered_taxonomy, filtered_data_pcoa, title="PCOA Ordination of terminal taxa using Bray-Curtis similarity")
